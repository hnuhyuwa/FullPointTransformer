...
def main():
    ...
    data_root = '/home/hnu/hy-data/data/s3dis/trainval_fullarea'
    ...
    for i in range(len(test_area)):
        ...
        result_path = '/home/hnu/hy-data/nextpaper/sem/s3dis/PT_test2_1/exp/s3dis/6-fold'  # where to save all result files
        ...
        with open(os.path.join(result_path, 'label_{}'.format(test_area[i]) + '.pickle'), 'rb') as handle:
